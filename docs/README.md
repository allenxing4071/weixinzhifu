...
2. **根目录README**：[../README.md](../README.md) - 项目快速上手
3. **部署指南**：[04-部署与运维/04-阿里云部署指南.md](04-部署与运维/04-阿里云部署指南.md)
...
### 数据库
- 数据库名：`weixin_payment`
- 核心表：users, merchants, payment_orders, user_points, point_records, admin_users
